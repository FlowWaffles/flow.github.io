import './Privacy.css';
import NyanCat from '../cat/NyanCat.tsx';
        ...
        <div className="privacy">
            ...
            <div className="privacy-text">
                <section>
                    ...
                    <h3>Overview</h3>
                    <p>The Android app is a Trusted Web Activity (TWA) built with Bubblewrap that wraps this website.
                        It does not contain any additional native code, SDKs, or libraries beyond what Bubblewrap
                        generates to display the site in a standalone app shell.</p>

                    <h3>Data Collection</h3>
                    <p>The app itself collects, stores, or transmits no personal data. It does not use Firebase,
                        analytics, crash reporting, advertising SDKs, or any other third-party service.</p>

                    <h3>Local Storage</h3>
                    <p>The app stores the following choices locally on your device only, so they persist between
                        sessions:</p>
                    <ul>
                        <li>Theme preference (light, dark, or static mode)</li>
                        <li>Player names</li>
                        <li>Commander selection</li>
                        <li>Player accent colors (MTG Commander Tracker)</li>
                    </ul>
                    <p>This data never leaves your device and is never transmitted to us, our hosting provider, or
                        any third party.</p>

                    <h3>Permissions</h3>
                    <p>The app does not request any device permissions.</p>

                    <h3>Deleting Your Data</h3>
                    <p>You can delete all locally stored app data at any time via the "Delete All Data" button in
                        the app's setup menu. This immediately and permanently removes all locally stored choices
                        listed above.</p>

                    <h3>Website Content Within the App</h3>
                    <p>When the app displays website content, the same website privacy practices described below
                        apply (essential cookies and hosting log files). Since the app runs as a standalone TWA
                        shell, cookies set are scoped to the app and are not shared with a separate browser.</p>
                ...
                <section>
                    ...
                    <h3>Hosting</h3>
                    <p>Our hosting provider collects the following data in so-called log files, which your browser
                        transmits:</p>
                    <ul>
                        <li>IP address</li>
                        <li>address of the previously visited website (referrer request header)</li>
                    ...
                    <p>You have the right to object to the processing. Whether the objection is successful must be
                        determined through a balancing of interests.</p>
                    <p>The data will be deleted as soon as the purpose for processing ceases.</p>
                    ...
                    <h3>Legal Notes</h3>
                    <p>As a rule, a data processing agreement must be concluded with the hosting provider.</p>
                    <p>The Bavarian State Office for Data Protection Supervision has made an exception for the hosting
                        of purely static websites.</p>
                ...
                <section>
                    ...
                    <p>Sie haben das Recht der Verarbeitung zu widersprechen. Ob der Widerspruch erfolgreich ist, ist im
                        Rahmen einer Interessenabwägung zu ermitteln.</p>
                    ...
                    <p>Grundsätzlich ist ein Auftragsverarbeitungsvertrag mit dem Hoster abzuschließen.</p>
                    <p>Das bayerische Landesamt für Datenschutzaufsicht hat für das Hosting rein statischer Websites
                        eine Ausnahme gemacht.</p>
